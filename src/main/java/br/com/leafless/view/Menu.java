...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        itemInicio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/inicio.png"))); // NOI18N
        ...
        itemGrupos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/grupo.png"))); // NOI18N
        itemGrupos.setText("  Grupos");
        itemGrupos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        itemSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/sair.png"))); // NOI18N
        ...
        itemUsuarios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/usuarios.png"))); // NOI18N
