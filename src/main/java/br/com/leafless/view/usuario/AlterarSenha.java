...
public class AlterarSenha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLayeredPane1.setLayer(cancelarAcao, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void cancelarAcaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarAcaoActionPerformed
        ...
        int resposta = JOptionPane.showOptionDialog(null, "Tem certeza que deseja cancelar a ação?", "Cancelar Alteração de Senha", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (resposta == JOptionPane.YES_OPTION) {
            TelasUtil.voltar();
        }
