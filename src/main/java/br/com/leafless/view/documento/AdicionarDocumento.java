package br.com.leafless.view.documento;
...
import br.com.leafless.model.Documento;
...
public class AdicionarDocumento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        concluirAdicao.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        procurarArquivo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void cancelarAcaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarAcaoActionPerformed
        ...
        int resposta = JOptionPane.showOptionDialog(null, "Tem certeza que deseja cancelar a ação?", "Cancelar Adição de Documentos", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (resposta == JOptionPane.YES_OPTION) {
            TelasUtil.voltar();
        }
    ...
    private void concluirAdicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_concluirAdicaoActionPerformed
        try {
            ...
            if (arquivoSelecionado != null) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Selecione um arquivo para adicionar.",
                        "Adição de Documento", JOptionPane.WARNING_MESSAGE, null);
            }
