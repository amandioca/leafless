package br.com.leafless.view.grupo;
...
import br.com.leafless.view.usuario.Cadastrar;
...
public class CriarGrupo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cancelarAcao1 = new javax.swing.JButton();
        ...
        cancelarAcao1.setBackground(new java.awt.Color(185, 8, 0));
        cancelarAcao1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        cancelarAcao1.setForeground(new java.awt.Color(229, 229, 229));
        cancelarAcao1.setText("Cancelar");
        cancelarAcao1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cancelarAcao1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cancelarAcao1ActionPerformed(evt);
            }
        });
        ...
        grupoTopico.setLayer(cancelarAcao1, javax.swing.JLayeredPane.DEFAULT_LAYER);
            ...
            .addGroup(grupoTopicoLayout.createSequentialGroup()
                .addGroup(grupoTopicoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(grupoTopicoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, grupoTopicoLayout.createSequentialGroup()
                            .addGap(0, 0, Short.MAX_VALUE)
                            .addComponent(jButton1)
                            .addGap(40, 40, 40)
                            .addComponent(cancelarAcao1)
                            .addGap(269, 269, 269))))
                .addContainerGap())
        );
    ...
    private void cancelarAcao1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarAcao1ActionPerformed
        Object[] options = {"Sim", "Não"};
        int resposta = JOptionPane.showOptionDialog(null, "Tem certeza que deseja cancelar a ação?", "Cancelar Criação de Grupo", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (resposta == JOptionPane.YES_OPTION) {
            TelasUtil.voltar();
        }
    }//GEN-LAST:event_cancelarAcao1ActionPerformed
    ...
    private javax.swing.JButton cancelarAcao1;
