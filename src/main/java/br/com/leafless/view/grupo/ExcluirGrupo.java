...
public class ExcluirGrupo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fotoPerfil.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void cancelarAcao1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarAcao1ActionPerformed
        ...
        int resposta = JOptionPane.showOptionDialog(null, "Tem certeza que deseja cancelar a ação?", "Cancelar Exclusão de Grupo", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (resposta == JOptionPane.YES_OPTION) {
            TelasUtil.voltar();
        }
