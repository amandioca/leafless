...
public class DeletarUsuario extends javax.swing.JFrame {
    ...
    private void cancelarAcaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarAcaoActionPerformed
        ...
        int resposta = JOptionPane.showOptionDialog(null, "Tem certeza que deseja cancelar a ação?", "Deletar Usuário", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        if (resposta == JOptionPane.YES_OPTION) {
            TelasUtil.trocarTela(DeletarUsuario.this, new Usuarios());
        }
    ...
    private javax.swing.JLayeredPane dadosPessoais1;
    ...
    private javax.swing.JTextField nomeApresentacao1;
